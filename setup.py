...
setup(
    ...
    install_requires=["requests", "boto3", "appdirs", "lazy-object-proxy", "openai-whisper", "pyaudio", "pydub", "colorama", "automodinit", "deepspeed", "docstring_parser", "jsonpickle", "shutils", "moviepy2", "nltk", "wget", "kokoro_onnx[gpu]", "websockets", "duckduckgo-search", "markdownify", "h2", "pyperclip"] 
)
