...
def makeArgParser(default_params):
    ...
    parser.add_argument("--http_port", type=int, default=5050, help="Port for the web server to lsiten on if --http is provided. By default, the --audio_websock_port will be --http_port+1, and --tts_websock_port will be --http_port+2, e.g. 5051 and 5052.")
    ...
    parser.add_argument("--audio_websock_port", type=int, default=5051, help="The address to bind to when `--audio_websock` is enabled. You can stream audio to this endpoint using the websocket protocol for audio transcription. Normally overriden by --http.")    
