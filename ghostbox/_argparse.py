...
def makeArgParser(default_params):
    ...
    parser.add_argument("--audio_websock_host", type=str, default="localhost", help="The address to bind to when `--audio_websock` is enabled. You can stream audio to this endpoint using the websocket protocol for audio transcription.")
    parser.add_argument("--audio_websock_port", type=int, default=5051, help="The address to bind to when `--audio_websock` is enabled. You can stream audio to this endpoint using the websocket protocol for audio transcription.")    
